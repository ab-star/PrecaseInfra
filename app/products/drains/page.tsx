...
const productSpecs = [
  {
    ...
    features: [
      ...
      { label: "Loading", value: "Pedestrian; 2.4 T/m² surcharge / 3.4 T Axle Load" },
      ...
      { label: "Usage", value: "Used for LMV , Cable Drains" },
    ],
    accentColor: "#1976d2",
  },
  {
    ...
    features: [
      ...
      { label: "Loading", value: "Pedestrian/LMV; 2.4 T/m² surcharge / 6 T Vehicle Load" },
  ...
  },
  {
    ...
    features: [
      ...
      { label: "Loading", value: "5 T wheel load / 2.4 T/m² surcharge" },
      { label: "Location", value: "Part of the road" },
      { label: "Connection", value: "Groove with sealants" },
      { label: "Lifting", value: "Inbuilt inserts" },
      { label: "Usage", value: "Used for heavy load vehicles, parallel to road" },
    ],
    accentColor: "#ed6c02",
  },
];
