	...
	>
		...
		<div className="relative z-10 flex-1 flex flex-col gap-8 items-start">
			<div className="flex items-center gap-4 mb-4">
				<span
					className="text-4xl font-extrabold tracking-wider drop-shadow-lg animate-pulse-slow"
					style={{
			...
			>
				...
				<div className="flex gap-6 mt-8 justify-center w-full">
					...
					>
						<FaFacebookF className="text-3xl group-hover:scale-125 animate-pulse-slow" />
					</a>
					<a
						href="#"
						className="group hover:text-blue-300 transition-all"
					>
						<FaTwitter className="text-3xl group-hover:scale-125 animate-pulse-slow" />
					</a>
					<a
						href="#"
						className="group hover:text-blue-500 transition-all"
					>
						<FaLinkedinIn className="text-3xl group-hover:scale-125 animate-pulse-slow" />
					</a>
				</div>
			</div>
		</div>
